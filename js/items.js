...
$(document).ready(function () {
  ...
  $('#item-instagram').dblclick(function () {
    window.open('https://instagram.com/frezzyterrorwashere');
  });


  $('#item-2-youtube').dblclick(function () {
    window.open('https://www.youtube.com/channel/UCELzE-DYL9iG-NyMWp3pfIw');
  });


  $('#item-2-discord').dblclick(function () {
    window.open('https://discord.gg/DnZ4xsY6hu');
  });


  $('#item-2-spotify').dblclick(function () {
    window.open('spotify:user:dsdsada');
  });
